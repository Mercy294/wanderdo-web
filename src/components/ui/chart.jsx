  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-gray-200 bg-white/95 backdrop-blur-sm px-2.5 py-1.5 text-xs shadow-xl",
          className,
        )}
      >
      ...
      >
        {payload.map((item) => {
          ...
          return (
            <div
              key={item.value}
              className="flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:w-3 [&>svg]:text-gray-400"
            >
